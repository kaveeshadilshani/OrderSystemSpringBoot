...
import com.dfn.oms.newgen.testClientUI.bean.CreateOrderComponent.Settings;
...
import static com.dfn.oms.newgen.testClientUI.Controller.UserController.userRepository;
public class JMSSender {
    ...
    public static Context getInitialContext() throws NamingException
    {
        ...
        String ip = userRepository.findById((long) userRepository.count()).get().getIp();
        String port = Integer.toString(userRepository.findById((long) userRepository.count()).get().getPort());
