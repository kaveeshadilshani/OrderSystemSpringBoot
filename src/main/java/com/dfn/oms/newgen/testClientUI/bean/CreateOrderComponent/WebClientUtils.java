...
import static com.dfn.oms.newgen.testClientUI.Controller.OrderController.orderAction;
import static com.dfn.oms.newgen.testClientUI.Controller.OrderController.sessionID;
public class WebClientUtils {
    ...
    public boolean processCommandLind() {
        ...
        if (action.trim().equals(Integer.toString(OMSConst.SERVICE_ID_CREATE_ORDER_NEW)) || action.trim().equals("9")) {
            ...
            populateRequests(true, UserController.userRepository.findById((long) UserController.userRepository.count()).get().getNoOfOrders(), Integer.parseInt(action), cashAcntCountsString);

        } else if ("3".equals(action.trim())) {
            //System.out.print("ClOrderID:");
            String clOrdID = UserController.hashMap_amendOrder.get(Integer.toString(UserController.hashMap_amendOrder.size())).getClOrdID();
            // System.out.print("Order qty:");
            // String orderQtyStr = scanner.next();

            orderQty = UserController.hashMap_amendOrder.get(Integer.toString(UserController.hashMap_amendOrder.size())).getOrderQty();

//            System.out.print("Price:");
            String priceStr = UserController.hashMap_amendOrder.get(Integer.toString(UserController.hashMap_amendOrder.size())).getPrice();
            try {
            ...
            //System.out.print("ClOrderID:");
            String clOrdID = UserController.hashMap_cancelOrder.get(Integer.toString(UserController.hashMap_cancelOrder.size())).getClOrdID();
...
//                message = "TDWL\u001C0\u001C23041\u001C8=FIXT.1.1" + OMSConst.FD + "9=000151" + OMSConst.FD + "35=h" + OMSConst.FD + "49=XSAU" + OMSConst.FD + "56=014" + OMSConst.FD + "34=844" + OMSConst.FD + "57=0140002" + OMSConst.FD + "143=null" + OMSConst.FD + "52=20170723-06:30:00.001" + OMSConst.FD + "335=1500780671363" + OMSConst.FD + "1300=ALL" + OMSConst.FD + "336=1" + OMSConst.FD + "625=2" + OMSConst.FD + "340=4" + OMSConst.FD + "1368=2" + OMSConst.FD + "341=20170723-06:30:00.000" + OMSConst.FD + "10=219" + OMSConst.FD + "";
    ...
    private String generateOrderRequest(Order order, int requestSequence,
        ...
        OrderParams orderParams = UserController.parameterRepository.findById((long) UserController.parameterRepository.count()).get();
        if (cashAcntID > 0) {
       ...
       orderRequestBean.getOmsMsgHeader().setLoginID(customerID);
        ...
        orderQty = UserController.userRepository.findById((long) UserController.userRepository.count()).get().getOrderQty();
